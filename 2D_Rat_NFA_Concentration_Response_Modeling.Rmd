---
title: "Activity Scan AUC Analysis"
author: Sierra Boyd
output:
  html_document:
    theme: cerulean
...
```{r}
setwd("C:/Users/sboyd01/OneDrive - Environmental Protection Agency (EPA)/Profile/Documents/Project-Chronic DNT Organoid/Data Analysis/Activity Analysis/Exported Figures")
getwd()
```
...
file.dir <- paste("C:/Users/sboyd01/OneDrive - Environmental Protection Agency (EPA)/Profile/Documents/Project-Chronic DNT Organoid/Data Analysis/Tipping Points/CF Tipping Points/Exports", sep="")
...
```{r}
write.csv(res,file = "C:/Users/sboyd01/OneDrive - Environmental Protection Agency (EPA)/Profile/Documents/Project-Chronic DNT Organoid/Data Analysis/Tipping Points/CF Tipping Points/CF_data_res.csv")
...
#save
ggsave("AUC_AC50_heatmap.png",plot=Maxwell_AUC_AC50,bg="white",width=7,height=5.5)
```